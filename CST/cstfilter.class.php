...
#CST:xdusek21
/**
 *	This file contains class with methods for filtering input data
 *
 *	@author Daniel Dusek (xdusek21) <dusekdan@gmail.com>	
 */

/**
 *	Class cstFilter contains a set of different methods used for filtering input data
 */
final class cstFilter
{

	// since cstFilter needs to use public methods provided by IOHandler class, this property servers that purpose
	private $iohandler;

	// array of input files provided by user is stored here
	private $inputFileArray = array();

	// property containing number of characters in commentaries in analyzed files
	private $comentLetters = 0;

	/**
	 *	Constructor for cstFilter class - fills the internal property $iohandler with reference to IOHandler class object
	 *	@param Obj|IOHandlerPtr
	 */
	...
	/**
	 *	This method is called from the outside and basically just runs the filter
	 */
	public function Run()
	{
	...
	/**
	 *	In this method is pretty much done everything with the switches - as a reaction to various events (values contained in $options), event in respond are done (processing the input data)
	 *	@param array|$options
	 */
	private function processOptions($options)
	{
		...
		// in an upcoming part, mostly regular expression definitions and content stripping + getting the exact count of appearances is done
	...
	/**
	 *	This method strips the variable of c commentaries, c macroes, c string literals and c char literals. FSM included.
	 * 	@param string|$fileContent
	 * 	@return string|$fileContent (stripped)
	 */
	...
	/**
	 *	Returns array of only names of the file
	 *	@param array|$files
	...
	/**
	 *	Counts a number of appearances of given mask in given formule
	 *	@param string|$pattern
	 *	@param string|$formula
	 *	@return int|$numberOfAppearances
	 */
	...
	/**
	 *	Nonrecursive version of scandir
	 *	@param url|dir
	 */
	...
	/**
	 *	Simple method to get only extension of a given file
	 *	@param url|$filename
